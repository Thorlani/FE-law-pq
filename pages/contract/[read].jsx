...
export async function getStaticPaths () {
  ...
  try {
    const result = await axios.get('https://be-law-pq.vercel.app/api/getContract');
...
export async function getStaticProps (context) {
  ...
  try {
    const res = await axios.get('https://be-law-pq.vercel.app/api/getContract/' + read)
    const result = await axios.get('https://be-law-pq.vercel.app/api/getCC');
...
const ContractRead = ({ data, comments }) => {
  ...
  const postComment = async (event) => {
    ...
    try {
      ...
      axios.post('https://be-law-pq.vercel.app/api/postCC', body)
      .then(res => {
        setIsLoading(false)
